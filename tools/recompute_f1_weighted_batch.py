...
def _evaluate_checkpoint(
    ...
    return {
        ...
        "precision_weighted_old": _metric(metrics_old, "precision_weighted"),
        "recall_weighted_old": _metric(metrics_old, "recall_weighted"),
        ...
        "precision_weighted": metrics_new["precision_weighted"],
        "recall_weighted": metrics_new["recall_weighted"],
