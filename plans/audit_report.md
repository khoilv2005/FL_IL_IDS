...
| EWC | `paper/EWC.pdf` | [`ewc.py`](fed_learning/strategies/fed_incremental/ewc.py:1) | [`client.py`](fed_learning/clients/client.py:1) | [`incremental_server.py`](fed_learning/servers/incremental_server.py:1) | [`worker.py`](fed_learning/training/worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
| FedLwF | `paper/Lwf.pdf` | [`fedlwf.py`](fed_learning/strategies/fed_incremental/fedlwf.py:1) | [`fedlwf_client.py`](fed_learning/clients/fedlwf_client.py:1) | [`fedlwf_server.py`](fed_learning/servers/fedlwf_server.py:1) | [`fedlwf_worker.py`](fed_learning/training/fedlwf_worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
| CGoFed | `paper/CGoFed_...pdf` | [`cgofed.py`](fed_learning/strategies/fed_incremental/cgofed.py:1) | [`cgofed_client.py`](fed_learning/clients/cgofed_client.py:1) | [`cgofed_server.py`](fed_learning/servers/cgofed_server.py:1) | [`cgofed_worker.py`](fed_learning/training/cgofed_worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
| DER | `paper/DER.pdf` | [`der.py`](fed_learning/strategies/fed_incremental/der.py:1) | [`der_client.py`](fed_learning/clients/der_client.py:1) | [`der_server.py`](fed_learning/servers/der_server.py:1) | [`der_worker.py`](fed_learning/training/der_worker.py:1) | [`der_model.py`](fed_learning/models/der_model.py:1) |
| FedCBDR | `paper/FEDCBDR.pdf` | [`fedcbdr.py`](fed_learning/strategies/fed_incremental/fedcbdr.py:1) | [`fedcbdr_client.py`](fed_learning/clients/fedcbdr_client.py:1) | [`fedcbdr_server.py`](fed_learning/servers/fedcbdr_server.py:1) | [`fedcbdr_worker.py`](fed_learning/training/fedcbdr_worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
| GLFC | `paper/GLFC.pdf` | [`glfc.py`](fed_learning/strategies/fed_incremental/glfc.py:1) | [`glfc_client.py`](fed_learning/clients/glfc_client.py:1) | [`glfc_server.py`](fed_learning/servers/glfc_server.py:1) | [`glfc_worker.py`](fed_learning/training/glfc_worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
| NICE | `paper/NICE.pdf` | [`nice.py`](fed_learning/strategies/fed_incremental/nice.py:1) | [`nice_client.py`](fed_learning/clients/nice_client.py:1) | [`nice_server.py`](fed_learning/servers/nice_server.py:1) | [`nice_worker.py`](fed_learning/training/nice_worker.py:1) | [`nice_model.py`](fed_learning/models/nice_model.py:1) |
| ReFed | `paper/Re-Fed.pdf` | [`refed.py`](fed_learning/strategies/fed_incremental/refed.py:1) | [`refed_client.py`](fed_learning/clients/refed_client.py:1) | [`refed_server.py`](fed_learning/servers/refed_server.py:1) | [`refed_worker.py`](fed_learning/training/refed_worker.py:1) | [`cnn_gru.py`](fed_learning/models/cnn_gru.py:1) |
...
**✅ Fisher Information** — [`EWCMixin.compute_fisher_information()`](fed_learning/strategies/fed_incremental/ewc.py:111) tính Fisher diagonal bằng bình phương gradient:
```python
...
**✅ Online EWC (Huszar correction)** — [`EWCMixin.consolidate()`](fed_learning/strategies/fed_incremental/ewc.py:165) thực hiện:
```python
...
**✅ EWC Loss** — [`EWCMixin.compute_loss()`](fed_learning/strategies/fed_incremental/ewc.py:273) tính:
```python
...
**✅ MRO Pattern** — [`FedAvgEWCTrainer(EWCMixin, FedAvgTrainer)`](fed_learning/strategies/fed_incremental/ewc.py:354) và [`FedProxEWCTrainer(EWCMixin, FedProxTrainer)`](fed_learning/strategies/fed_incremental/ewc.py:369) cho phép kết hợp EWC với FedAvg hoặc FedProx.

#### Sai lệch phát hiện

| Mức | Mô tả | Vị trí code | Phương trình paper |
|-----|-------|-------------|-------------------|
| 🟡 MED | Fisher chỉ dùng 1 sample/batch thay vì full dataset | [`compute_fisher_information()`](fed_learning/strategies/fed_incremental/ewc.py:127) | Paper: E over full data |
...
**✅ KD Loss** — [`FedLwFTrainer.compute_distillation_loss()`](fed_learning/strategies/fed_incremental/fedlwf.py:178) tính:
```python
...
**✅ Combined Loss** — [`FedLwFTrainer.compute_loss()`](fed_learning/strategies/fed_incremental/fedlwf.py:212):
```python
total_loss = ce_loss + self.distill_weight * kd_loss
```
Đúng cấu trúc L = L_CE + α·L_KD.

**✅ Teacher Snapshot** — [`FedLwFTrainer.save_model_snapshot()`](fed_learning/strategies/fed_incremental/fedlwf.py:110) lưu trạng thái model trước task mới.

**✅ Proximal Variant** — [`FedLwFWithProximalTrainer`](fed_learning/strategies/fed_incremental/fedlwf.py:326) kết hợp LwF + FedProx proximal term.

#### Sai lệch phát hiện

| Mức | Mô tả | Vị trí code | Phương trình paper |
|-----|-------|-------------|-------------------|
| 🔴 HIGH | KL divergence bị đảo chiều: KL(student‖teacher) thay vì KL(teacher‖student) | [`compute_distillation_loss()`](fed_learning/strategies/fed_incremental/fedlwf.py:178) | Eq. KD loss |
| 🟡 MED | Distillation chỉ áp dụng trên old_classes logits, không trên full output | [`compute_distillation_loss()`](fed_learning/strategies/fed_incremental/fedlwf.py:178) | Paper dùng full output |
...
**✅ SVD-based Space** — [`CGoFedTrainer.build_representation_space()`](fed_learning/strategies/fed_incremental/cgofed.py:505) thu thập activations và thực hiện SVD:
```python
U, S, Vt = torch.linalg.svd(activation_matrix, full_matrices=False)
```
Giữ top-k singular vectors theo threshold. Đúng paper Eq.2-3.

**✅ Relaxation Coefficient** — [`CGoFedTrainer.pre_step()`](fed_learning/strategies/fed_incremental/cgofed.py:671) tính:
```python
alpha = self.alpha_init * ((1.0 - progress) ** self.alpha_power)
```
Đúng Eq.7-8: α(t) = α_init · (1 - t/T)^p.

**✅ Gradient Projection** — Trong [`pre_step()`](fed_learning/strategies/fed_incremental/cgofed.py:694):
```python
proj = U @ (U.T @ grad)
...
**✅ Cross-task Similarity** — [`CGoFedServer._compute_similarity()`](fed_learning/servers/cgofed_server.py:289) tính cosine similarity giữa hai representation matrices. [`CGoFedAggregator._compute_similarity()`](fed_learning/strategies/fed_incremental/cgofed.py:1097) cũng tương tự. Phù hợp Eq.10.

**✅ Top-K Selection** — [`CGoFedAggregator._select_top_k_similar()`](fed_learning/strategies/fed_incremental/cgofed.py:1129) chọn top K models giống nhất dựa trên similarity score.
...
**✅ Cross-task Regularization** — [`CGoFedTrainer.compute_loss()`](fed_learning/strategies/fed_incremental/cgofed.py:624) thêm:
```python
...
| Mức | Mô tả | Vị trí code | Phương trình paper |
|-----|-------|-------------|-------------------|
| 🟡 MED | Projection thực hiện trên **tất cả layers** thay vì chỉ projection target modules | [`pre_step()`](fed_learning/strategies/fed_incremental/cgofed.py:718) | Paper: chỉ trên convolutional layers |
| 🟢 LOW | SVD threshold dùng energy ratio cố định, paper dùng adaptive | [`build_representation_space()`](fed_learning/strategies/fed_incremental/cgofed.py:553) | Eq.3 |
| 🟢 LOW | Cache projection matrices giữa các epochs thay vì tính lại | [`_cache_projection_matrices()`](fed_learning/strategies/fed_incremental/cgofed.py:835) | Paper tính mỗi step |

**Chi tiết MED**: Code trong [`pre_step()`](fed_learning/strategies/fed_incremental/cgofed.py:718) duyệt `all_layers` bao gồm tất cả named parameters, nhưng có fallback logic kiểm tra xem layer có trong projection cache không. Nếu không có, gradient giữ nguyên. Thực tế, [`_cache_projection_matrices()`](fed_learning/strategies/fed_incremental/cgofed.py:835) chỉ tạo cache cho các module được chỉ định, nên impact thực tế nhỏ hơn.
...
**✅ Mask Annealing** — [`DERTrainer.compute_annealing_s()`](fed_learning/strategies/fed_incremental/der.py:114):
```python
...
**✅ Stage 1 Loss** — [`DERTrainer._stage1_loss()`](fed_learning/strategies/fed_incremental/der.py:167):
```python
total = ce_loss + self.lambda_aux * aux_loss + self.lambda_s * sparsity_loss
```
Đúng Eq.11: L = L_CE + λ_a·L_aux + λ_s·L_S.

**✅ Stage 2 Balanced Finetuning** — [`DERTrainer._stage2_loss()`](fed_learning/strategies/fed_incremental/der.py:208) train với balanced data, temperature scaling: `output / self.delta`. [`DERClient._create_balanced_batches()`](fed_learning/clients/der_client.py:315) tạo balanced batches.
...
**✅ DERAggregator** — [`DERAggregator.aggregate()`](fed_learning/strategies/fed_incremental/der.py:309) chỉ aggregate trainable keys, giữ nguyên frozen extractor params. Đúng.
...
| 🟢 LOW | Annealing schedule linear thay vì cosine/other schedules | [`compute_annealing_s()`](fed_learning/strategies/fed_incremental/der.py:114) | Paper: linear is default |
...
**✅ TTS Loss** — [`FedCBDRTrainer._compute_tts_loss()`](fed_learning/strategies/fed_incremental/fedcbdr.py:125):
```python
...
**✅ Replay Buffer** — [`ReplayBuffer`](fed_learning/strategies/fed_incremental/fedcbdr.py:240) class với `max_size`, class-balanced rebalancing. [`ReplayBuffer._rebalance()`](fed_learning/strategies/fed_incremental/fedcbdr.py:336) giữ đều samples per class. Đúng paper.

**✅ Leverage Score** — [`LeverageScoreCalculator.compute_scores()`](fed_learning/strategies/fed_incremental/fedcbdr.py:447) dùng SVD:
```python
...
| Mức | Mô tả | Vị trí code | Phương trình paper |
|-----|-------|-------------|-------------------|
| 🟡 MED | TTS loss dùng concat+CE thay vì separate softmax losses | [`_compute_tts_loss()`](fed_learning/strategies/fed_incremental/fedcbdr.py:125) | Paper: separate CE cho old/new |
| 🟡 MED | `compute_scores_encrypted()` chưa hoàn thiện — chỉ placeholder | [`compute_scores_encrypted()`](fed_learning/strategies/fed_incremental/fedcbdr.py:486) | Paper: privacy-preserving computation |
...
**Chi tiết MED (encrypted)**: [`compute_scores_encrypted()`](fed_learning/strategies/fed_incremental/fedcbdr.py:486) dùng random orthogonal matrix nhân features trước SVD. Đây là simplified privacy mechanism, không phải full homomorphic encryption hay secure aggregation như paper mô tả.
...
**✅ Local Forgetting Compensation** — [`GLFCTrainer.compute_loss()`](fed_learning/strategies/fed_incremental/glfc.py:353):
```python
...
**✅ Class-aware Gradient Compensation** — [`GLFCTrainer.efficient_old_class_weight()`](fed_learning/strategies/fed_incremental/glfc.py:286) tính trọng số bù cho old classes:
```python
...
**✅ Entropy Signal** — [`GLFCTrainer.compute_entropy_signal()`](fed_learning/strategies/fed_incremental/glfc.py:237):
```python
...
| 🟡 MED | `efficient_old_class_weight()` dùng simplified softmax-based weighting | [`efficient_old_class_weight()`](fed_learning/strategies/fed_incremental/glfc.py:286) | Paper: formal gradient compensation |
...
**✅ τ-greedy Selection** — [`pick_top_neurons()`](fed_learning/strategies/fed_incremental/nice.py:30):
```python
...
**✅ `select_learner_units()`](fed_learning/strategies/fed_incremental/nice.py:61)** — Forward pass → get activations → pick_top_neurons → set selected to learner (rank=1). Đúng paper.
...
**✅ NICEAggregator** — [`NICEAggregator.aggregate()`](fed_learning/strategies/fed_incremental/nice.py:401) bảo vệ per-neuron frozen parameters khi aggregation bằng freeze masks. Đúng — paper yêu cầu mature neurons không bị thay đổi bởi aggregation.
...
**✅ FedAvg Aggregation** — [`ReFedAggregator.aggregate()`](fed_learning/strategies/fed_incremental/refed.py:113) gọi `_weighted_average()`. Đúng — paper nhấn mạnh server-side đơn giản.
...
| EWC | **A** | Fisher trên subset data | [`ewc.py`](fed_learning/strategies/fed_incremental/ewc.py:1) |
| FedLwF | **B** | KL divergence đảo chiều | [`fedlwf.py`](fed_learning/strategies/fed_incremental/fedlwf.py:1) |
| CGoFed | **A** | SVD threshold, projection scope nhỏ | [`cgofed.py`](fed_learning/strategies/fed_incremental/cgofed.py:1) |
| DER | **A** | Aux classifier +1 class | [`der.py`](fed_learning/strategies/fed_incremental/der.py:1), [`der_model.py`](fed_learning/models/der_model.py:1) |
| FedCBDR | **B** | TTS loss concat thay vì separate | [`fedcbdr.py`](fed_learning/strategies/fed_incremental/fedcbdr.py:1) |
| GLFC | **B** | Proxy server no gradient inversion | [`glfc.py`](fed_learning/strategies/fed_incremental/glfc.py:1), [`glfc_server.py`](fed_learning/servers/glfc_server.py:1) |
| NICE | **A** | Context detector không integrate inference | [`nice.py`](fed_learning/strategies/fed_incremental/nice.py:1), [`nice_model.py`](fed_learning/models/nice_model.py:1) |
| ReFed | **B** | Loss-based thay gradient-based importance | [`refed.py`](fed_learning/strategies/fed_incremental/refed.py:1), [`refed_client.py`](fed_learning/clients/refed_client.py:1) |
...
|---|-----------|-------|------|------|
| 1 | FedLwF | **Sửa KL divergence direction**: Đổi `input` thành `F.log_softmax(new_logits/T)` và `target` thành `F.softmax(old_logits/T)` trong `F.kl_div()` | [`fedlwf.py`](fed_learning/strategies/fed_incremental/fedlwf.py:178) | ~195-198 |

### 🟡 Ưu tiên TRUNG BÌNH (Ảnh hưởng performance)

| # | Thuật toán | Mô tả | File | Dòng |
|---|-----------|-------|------|------|
| 2 | FedCBDR | **Tách TTS loss**: Tính separate CE loss cho old/new logits thay vì concat | [`fedcbdr.py`](fed_learning/strategies/fed_incremental/fedcbdr.py:125) | ~140-155 |
...
| 5 | FedCBDR | **Hoàn thiện encrypted computation**: Implement proper secure aggregation trong `compute_scores_encrypted()` hoặc xóa / mark clearly as simplified | [`fedcbdr.py`](fed_learning/strategies/fed_incremental/fedcbdr.py:486) | ~486-518 |
...
| 7 | CGoFed | Cân nhắc adaptive SVD threshold thay vì fixed energy ratio | [`cgofed.py`](fed_learning/strategies/fed_incremental/cgofed.py:553) |
...
| 9 | EWC | Tăng `max_batches` cho Fisher computation hoặc dùng full dataset | [`ewc.py`](fed_learning/strategies/fed_incremental/ewc.py:127) |
